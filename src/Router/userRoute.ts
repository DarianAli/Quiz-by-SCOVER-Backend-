...
import { addData, profileData, updateData, updatePasswordData, updatePasswordDataUser, verifyLogin } from "../middleware/userValidation";
import { phoneValidation } from "../validator/phoneValidator";
import { auth, createUser, deleteUser, getAllUser, getById, updatePasswordAdmin, updatePasswordUser, updatePicture, updateUser } from "../controller/user-controller";
